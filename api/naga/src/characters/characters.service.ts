...
export class CharactersService {
    ...
    async getAllCharacters(page: number, limit: number, sortBy: string, order: string): Promise<Array<Record<string, any>>> {
        ...
        const finalData = sortedData.slice(startIdx, startIdx + limit);
